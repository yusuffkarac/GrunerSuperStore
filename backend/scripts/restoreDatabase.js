...
// Geçici fix: Gruner tenant için direkt DB_NAME ayarla
let DB_NAME = process.env.DB_NAME || 'gruner_superstore';
if (tenantName === 'gruner') {
  DB_NAME = 'gruner_superstore';
  console.log(`🔧 Gruner tenant için DB_NAME zorla ayarlandı: ${DB_NAME}`);
}
